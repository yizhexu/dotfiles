...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (cherry-blossom-theme monokai-theme use-package tramp-term toc-org smartparens smart-mode-line rainbow-delimiters py-autopep8 paredit pallet org-ref org-plus-contrib org-bullets org nord-theme neotree multiple-cursors multi-term minions material-theme julia-repl jedi guide-key go-eldoc go-autocomplete flycheck evil-magit ess ensime elpy diff-hl company-jedi company-go color-identifiers-mode auto-compile))))
(custom-set-faces
