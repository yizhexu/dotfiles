...
#+begin_src emacs-lisp
  (setq user-full-name "Yizhe Xu"
        ...
        calendar-latitude 39.6701627,
        calendar-longitude -104.9804092)
#+end_src
...
#+BEGIN_SRC emacs-lisp
  (use-package aggressive-indent
    ...
    (add-to-list 'aggressive-indent-excluded-modes 'html-mode 'scala-mode)
...
#+begin_src emacs-lisp
  (use-package org-gcal
    ...
    :config
    (setq org-gcal-client-id "igracex@gmail.com"
          org-gcal-client-secret "TcMRv6WsmbTXOyay_CTfYYlV"
          org-gcal-file-alist '(("igracex@gmail.com" .  "~/Documents/megrez/todo.org")
