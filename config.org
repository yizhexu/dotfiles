...
(use-package org-ref
  :init
  ;; setup org-ref
  (setq org-ref-default-bibliography '("/Volumes/Keybase (p2762265)/private/yizhe/references/library.bib")
        org-ref-pdf-directory "/Volumes/Keybase (p2762265)/private/yizhe/references")
