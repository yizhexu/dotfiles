...
(when (is-mac-p)
  (setq keybase-ref "/Volumes/Keybase\ (p2762265)/private/yizhe/references/"
        mendeley-lib-bib "/Volumes/Keybase\ (p2762265)/private/yizhe/references/library.bib"))

(when (is-linux-p)
  (setq keybase-ref "/keybase/private/yizhe/references/"
        mendeley-lib-bib "/keybase/private/yizhe/references/library.bib"))
#+END_SRC
...
(use-package org-ref
  :init
  ;; setup org-ref
  (setq org-ref-default-bibliography '(mendeley-lib-bib)
...
#+begin_src emacs-lisp
(setq org-agenda-files (quote ("~/Documents/megrez/todo.org")))
#+end_src
