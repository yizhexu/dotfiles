...
#+RESULTS:
: #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (23658 15950 56169 219000) :init (23658 15950 56164 800000) :config (23658 15950 56098 697000) :config-secs (0 0 5829 431000) :init-secs (0 0 39105 169000) :use-package-secs (0 0 566049 142000)))
...
(setq org-capture-templates '(("t" "Todo [inbox]" entry
                               ...
                               "* TODO %i%?")
                              ("T" "Tickler" entry
                               (file+headline "~/Documents/megrez/tickler.org" "Tickler")
                               "* %i%? \n %U")))
#+end_src

#+RESULTS:
| t | Todo [inbox] | entry | (file+headline org-index-file Tasks)                   | * TODO %i%? |
| T | Tickler      | entry | (file+headline ~/Documents/megrez/tickler.org Tickler) | * %i%?      |

*** Refile Templates

#+begin_src emacs-lisp
(setq org-refile-targets '(("~/Documents/megrez/projects.org" :maxlevel . 3)
                           ("~/Documents/megrez/later.org" :level . 1)
                           ("~/Documents/megrez/tickler.org" :maxlevel . 2)))
#+end_src

#+RESULTS:
: ((~/Documents/megrez/projects.org :maxlevel . 3) (~/Documents/megrez/later.org :level . 1) (~/Documents/megrez/tickler.org :maxlevel . 2))

*** Agenda Categorization
Set agenda files
#+begin_src emacs-lisp
(setq org-agenda-files '("~/Documents/megrez/index.org"
                         "~/Documents/megrez/projects.org"
                         "~/Documents/megrez/tickler.org"))
#+end_src

#+RESULTS:
| ~/Documents/megrez/index.org | ~/Documents/megrez/projects.org | ~/Documents/megrez/tickler.org |
