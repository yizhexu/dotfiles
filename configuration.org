...
(setq org-capture-templates '(("t" "Todo [inbox]" entry
                               (file+headline	(org-file-path "index.org") "Tasks")
                               "* TODO %i%?")
                              ("T" "Tickler" entry
...
#+RESULTS:
| t | Todo [inbox] | entry | (file+headline (org-file-path index.org) Tasks)     | * TODO %i%? |
...
#+RESULTS:
: ((org-file-path projects.org :maxlevel . 3) (org-file-path later.org :level . 1))
...
Anki editor to use org mode manage my flashcards
