...
(custom-set-faces
  ...
  '(default ((t (:stipple nil :background nil :foreground nil :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 120 :width normal :family "Hack")))))
#+END_SRC
...
#!/usr/bin/env bash
ssh lynx -t "/home/ubuntu/.local/share/virtualenvs/sandbox/bin/ipython $@"
#+END_SRC
