...
#+BEGIN_SRC emacs-lisp
(when (is-linux-p) (yizhe/append-to-path "~/.pyenv/shims/python"))
...
#+BEGIN_SRC emacs-lisp
(when (is-linux-p) (yizhe/append-to-path "~/Downloads/remote-python"))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
(when (is-linux-p)
  (yizhe/append-to-path "/usr/local/julia/julia-current/bin"))
#+END_SRC
...
(use-package org
  ...
  (setq default-major-mode 'org-mode
        ...
        ;; org-tag-persistent-alist '(("baby" . ?b)
        ;;                            ("career" . ?c)
        ;;                            ("errands" . ?e)
        ;;                            ("fun" . ?f)
        ;;                            ("grow" . ?g)
...
(setq org-capture-templates
      (quote (("t" "Task")
              ...
              ("n" "Notes" entry
               (file+headline (concat org-directory org-default-notes-file) "new")
               "%?")
...
#+BEGIN_SRC emacs-lisp
(when (is-linux-p) (yizhe/append-to-path "/usr/local/WordNet-3.0/bin"))
...
(use-package org-journal
  :custom
  (org-journal-dir (concat org-directory "zettelkasten"))
...
(use-package deft
  ...
  (deft-directory (concat org-directory "zettelkasten")))
#+END_SRC

** =org-roam=

Testing out [[https://github.com/jethrokuan/org-roam][org-roam]]
...
(use-package org-roam
  ...
  (org-roam-use-timestamp-as-filename nil) ; prefer manually control file names
  :bind
  ("<C-f7>" . org-roam)
  (:map org-mode-map
